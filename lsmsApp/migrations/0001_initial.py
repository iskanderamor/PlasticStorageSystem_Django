# Generated by Django 4.0.3 on 2022-09-22 07:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.FloatField(max_length=15)),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_fk', to='lsmsApp.invoice')),
                ('product_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products_fk', to='lsmsApp.products')),
            ],
            options={
